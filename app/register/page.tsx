          ...
          <div className="flex justify-center md:justify-end">
            <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
              ...
              <div className="space-y-3">
                ...
                {error && (
                  <div className="w-full text-red-600 text-sm text-center bg-red-50 p-2 rounded">
                    {error}
                  </div>
                )}
                {success && (
                  <div className="w-full text-green-600 text-sm text-center bg-green-50 p-2 rounded">
                    {success}
                  </div>
                )}
