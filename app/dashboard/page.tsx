                ...
                <div className="w-full">
                    ...
                    <div>
                        <div className="bg-white rounded-lg shadow p-6 mb-4">
                            ...
                            <p className="text-gray-600">Start connecting with friends and sharing your moments.</p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <p className="text-gray-800 mb-4">This is your first post on social-connect!</p>
